...
insert into posref(posId, location, active) values ('POS-01', 'Vallauris', true)
insert into posref(posId, location, active) values ('POS-02', 'Blois', true)
insert into posref(posId, location, active) values ('POS-03', 'Paris', false)
